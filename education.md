...
- Developed and maintained internal,  business applications using **C#, .NET MVC, SQL Server, and Web APIs** on the Internal Software Development Department.
- Implemented **frontend components** using **React, TypeScript, and jQuery** 
